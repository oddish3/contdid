...
Rcpp::List jlep(arma::uword Lhat, const arma::mat& Px, const arma::mat& PP, const arma::mat& BB,
  ...
  for (arma::uword i = 0; i < Lmax - 1; ++i) {
    for (arma::uword j = i + 1; j < Lmax; ++j) {
      ...
      arma::vec c1 = Rcpp::as<arma::vec>(npiv1["c"]);
      arma::vec u1 = Rcpp::as<arma::vec>(npiv1["uhat"]);
      arma::mat Q1 = Rcpp::as<arma::mat>(npiv1["Q"]);
      arma::vec c2 = Rcpp::as<arma::vec>(npiv2["c"]);
      arma::vec u2 = Rcpp::as<arma::vec>(npiv2["uhat"]);
      arma::mat Q2 = Rcpp::as<arma::mat>(npiv2["Q"]);
  ...
  arma::vec z = arma::max(arma::max(ZZ, 0), 1);
  ...
  arma::uword LL = indices.is_empty() ? 0 : indices(0);
